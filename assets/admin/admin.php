...
<?php include('includes/leftsidebar.php');?>
            ...
            <div class="content-center ml-28">
                ...
                <form action="" method="POST">
                    ...
                    <div class="w-full md:w-1/2 px-3 py-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="bg-gray-50 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500" id="alamat" name="alamat" value="<?php echo $alamat ?>">
                        </div>
                    </div>
                    <br>
                    <div class="w-full md:w-1/2 px-3 py-4">
        ...
        <div class="my-auto pl-16 block bg-slate-50">
            ...
            <div class="card-body ">
                <table class="table-fixed">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="">
                                <th class="border px-9 py-4"><?php echo $urut++ ?></th>
                                <td class="border px-9 py-4"><?php echo $NIS ?></td>
                                <td class="border px-9 py-4"><?php echo $name ?></td>
                                <td class="border px-9 py-4"><?php echo $alamat ?></td>
                                <td class="border px-9 py-4"><?php echo $kelas ?></td>
