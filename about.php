    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2></h2>
          <ol class="bg-red-800 rounded px-3 py-3 absolute right-6 mt-10 top-24">
            <li><a href="index.html" class="text-slate-100 ">Home</a></li>
            <li class="text-slate-100">Visi Misi</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="row" >
          ...
          <div class="col-lg-6 mt-4 mt-lg-0" >
            <div class="member shadow-sm align-items-start  " >
